    ...
    return (
        <section className="bg-white w-screen h-screen flex flex-col items-center overflow-hidden justify-start gap-8">
            ...
            <div className="flex flex-row w-screen h-3/6 justify-center gap-8">
                <div className="flex relative w-3/12 h-full aspect-square">
                    <Image
                        fill
                        className="w-full h-full border-4 border-[#6f5956] rounded-2xl"
                        src={currentImage}
                        alt={`${currentName} picture`}
                    />
                </div>
                ...
                {teamMembers.map((member, index) => (
                    ...
                    >
                        <div className="flex flex-col items-start text-center">
                            <Image
                                className="border-2 border-[#6f5956] rounded-2xl hover:border-[#a0d5c0] hover:border-4"
                                src={member.picture}

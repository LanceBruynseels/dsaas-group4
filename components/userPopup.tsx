...
import {useEffect, useState} from "react"; // Assuming you're using Next.js for navigation
    ...
    return (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-50">
            <div className="relative w-full h-[600px] max-w-4xl p-4 bg-white rounded-lg shadow-lg lg:p-6">
                ...
                <div className="flex flex-col h-full  lg:flex-row lg:p-4">
                        <Image className={"absolute top-0 items-center z-50 "} src={"/new-match.png"} alt={"new-match"} width={200} height={200}></Image>

                        <FlowbiteCarousel
                            pictures={currentMatch.publicUrls || []}
                            infoSection={<div className="flex flex-col w-full mt-6 lg:mt-0 lg:w-1/2 lg:pl-6">
                    ...
                    <div className="flex flex-col w-full mt-6 lg:mt-0 lg:w-1/2 lg:pl-6">
                        {/* "New Match Found" Text */}
                        {!isSmallScreen ? (<>
                        <h2 className="text-3xl font-extrabold mb-8 text-[#00AA00]">
                            New Match Found! 🎉🎉
